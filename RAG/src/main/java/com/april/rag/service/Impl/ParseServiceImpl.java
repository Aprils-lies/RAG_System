...
import com.april.rag.service.ParseService;
...
public class ParseServiceImpl implements ParseService {
    ...
    private class StreamingContentHandler extends BodyContentHandler {
        ...
        private void processParentChunk() {
            ...
            // 1. 将父块分割成更小的、有语义的子切片
            List<String> childChunks = ParseServiceImpl.this.splitTextIntoChunksWithSemantics(parentChunkText, chunkSize);

            // 2. 将子切片批量保存到数据库
            this.savedChunkCount = ParseServiceImpl.this.saveChildChunks(fileMd5, childChunks, userId, orgTag, isPublic, this.savedChunkCount);
