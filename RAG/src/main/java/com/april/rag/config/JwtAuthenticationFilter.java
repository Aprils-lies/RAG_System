...
import com.april.rag.service.Impl.CustomUserDetailsServiceImpl;
...
/**
 * @Author: 四月是你的谎言
 * @CreateTime: 2026/2/7 21:22
 * Description:自定义的过滤器，用于解析请求头中的 JWT Token，并验证用户身份。
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private CustomUserDetailsServiceImpl userDetailsService; // 加载用户详细信息
