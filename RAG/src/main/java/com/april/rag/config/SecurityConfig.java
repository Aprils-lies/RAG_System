        ...
        try {
            ...
            http.csrf(csrf -> csrf.disable())
                    ...
                    .authorizeHttpRequests(authorize -> authorize
                            // 允许静态资源访问
                            .requestMatchers("/", "/test.html", "/static/**", "/resources/static/**", "/*.js", "/*.css", "/*.ico").permitAll()
                            // 允许 WebSocket 连接
                            ...
                            .requestMatchers("/api/v1/upload/**", "/api/v1/parse", "/api/v1/documents/**","/api/v1/documents/download", "/api/v1/documents/preview").permitAll()
