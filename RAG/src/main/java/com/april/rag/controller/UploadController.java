    ...
    public ResponseEntity<Map<String, Object>> mergeFile(
        ...
        try {
            ...
            LambdaQueryWrapper<FileUpload> eq = new LambdaQueryWrapper<FileUpload>()
                    .eq(FileUpload::getFileMd5, request.fileMd5())
                    .eq(FileUpload::getUserId, userId)
                    .last("limit 1");

            FileUpload fileUpload = fileUploadMapper.selectOne(eq);
