...
/**
 * @Author: 四月是你的谎言
 * @CreateTime: 2026/1/30 20:00
 * Description:日志工具类 提供统一的日志记录方法和格式
 */

public class LogUtils {
    // 业务日志记录器
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.april.rag.business");

    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.april.rag.performance");
